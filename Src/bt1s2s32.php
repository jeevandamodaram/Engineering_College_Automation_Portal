...
$ssql = "SELECT s3 FROM bsi  WHERE sem= '2' ";
...
//echo "$s";
echo "<form  method='post' action='succes.php?stid=". $qrow['stid'] ."   &    rno=" . $qrow['rno'] ." & sub= ".$s3."  & pg= ".$page." & pid= ".$pid." & fmid=".$m." & edu=".$edu." '>";
...
echo " <td width='10%'>";
echo " <input class='minput' name='marks'  type='number' min=1 max=30 maxlength='2' placeholder=". $qrow["s3"]. "  required style='font-weight: bold; font-family: Century Gothic; color: #85144b' /></td>";

echo "<td  width='10%' >  <button class='button1'> Update </button> </td>";

echo "<td  width='10%' ><p align='center' style='font-size:20px; color:#85144b'>" . $qrow["s3"].  " </p> </td>";
