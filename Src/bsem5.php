...
$csql = "SELECT s1 FROM fbatiii WHERE fname='$as' ";
...
$dsql = "SELECT s1 FROM fbatiii WHERE fname='$bs' ";
...
$esql = "SELECT s1 FROM fbatiii WHERE fname='$cs' ";
...
$fsql = "SELECT s1 FROM fbatiii WHERE fname='$ds' ";
...
$gsql = "SELECT s1 FROM fbatiii WHERE fname='$es' ";
...
$hsql = "SELECT s1 FROM fbatiii WHERE fname='$fs' ";
...
$isql = "SELECT l1 FROM fbatiii WHERE fname='$gl' ";
...
$zsql = "SELECT l1 FROM fbatiii WHERE fname='$hl' ";
