...
<div id="top2">
			<p align="center" style=" color:#FFFFFF; font-size:30px; font-family:'Times New Roman', Times, serif"><strong>Register & Update  B.Tech&nbsp; II<sup>nd</sup>&nbsp; Year &nbsp;Student's List    </strong></p>
</div>
...
<div id="fbtop4">
 ...
 <form name="bstu"   method='post' action='bbstup.php?page=<? echo" $page "; ?> & pid=2 & edu=b'  >
...
<select size="1" name="byear" id="select2" style="font-weight: bold; font-family: Century Gothic; color: #85144b">
 <option value="2015 to 2019">2015 to 2019</option>
</select>
</font></h3></center></td>
<td width="8%"><center><h3 style="color:#85144b"><font face="Century Gothic">
...
<div align="center"  style="color:#85144b ; font-size:18px;"><h3>Update B.Tech&nbsp; II<sup>nd</sup>&nbsp; Year &nbsp;Student List  [ CSE ]</h3></div>
...
$sql = "SELECT * FROM studet WHERE pyear='2' AND edu='b'  ORDER BY rnumber ASC";
$result = mysqli_query($conn, $sql);
 $count=1;
while($row = mysqli_fetch_assoc($result)) {
//echo $row['sname'];
echo"<form   method='post'  action='ubstup.php?page=". $page ." & stid=". $row['stid'] ." & pid=2 & edu=b '  >"; 
