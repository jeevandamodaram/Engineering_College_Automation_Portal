...
$sql = "SELECT * FROM midi  WHERE stid='$stid' OR rno='$rno' AND pyear='1' AND edu='b'  ";
...
echo"$il1"; 
echo"$il2"; 
$asql = "SELECT * FROM midii  WHERE stid='$stid' OR rno='$rno' AND pyear='1' AND edu='b'  ";
...
echo"</tr>";
$usql = "UPDATE mid SET m='$tmt', s1='$ms1',s2='$ms2',s3='$ms3',s4='$ms4',s5='$ms5',s6='$ms6',L1='$ml1',L2='$ml2'  WHERE stid='$stid' OR rno='$rno' AND pyear='1' AND edu='b'  ";
...
$psql = "SELECT * FROM mid WHERE  stid='$stid' AND pyear='1'  ";
...
if($wcheck=1){
   ...
   $dmsql="UPDATE studet SET mstatus=2 WHERE stid='$stid' AND pyear='1' AND edu='b'  ";
...
$bsql = "SELECT * FROM bati  WHERE stid='$stid' OR rno='$rno' AND pyear='1' AND edu='b'  ";
...
$isql = "SELECT l1 FROM fbati WHERE fname='$gl' ";
...
$zsql = "SELECT l1 FROM fbati WHERE fname='$hl' ";
...
$lsql = "UPDATE mid SET atd='$tat'   WHERE stid='$stid' OR rno='$rno' AND pyear='1' AND edu='b'  ";
...
$ksql = "SELECT * FROM mid  WHERE stid='$stid' OR rno='$rno' AND pyear='1' AND edu='b'  ";
...
if($qcheck>=1){
   $qquery="UPDATE studet SET astatus=2 WHERE stid='$stid' AND pyear='1' AND edu='b'  ";
...
$pqsql = "UPDATE  stuclear SET a='1' WHERE sem='1'  ";
