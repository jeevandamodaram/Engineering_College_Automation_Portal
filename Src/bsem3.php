...
$csql = "SELECT s1 FROM fbatii WHERE fname='$as' ";
...
$dsql = "SELECT s1 FROM fbatii WHERE fname='$bs' ";
...
$esql = "SELECT s1 FROM fbatii WHERE fname='$cs' ";
...
$fsql = "SELECT s1 FROM fbatii WHERE fname='$ds' ";
...
$gsql = "SELECT s1 FROM fbatii WHERE fname='$es' ";
...
$hsql = "SELECT s1 FROM fbatii WHERE fname='$fs' ";
...
$isql = "SELECT l1 FROM fbatii WHERE fname='$gl' ";
...
$zsql = "SELECT l1 FROM fbatii WHERE fname='$hl' ";
