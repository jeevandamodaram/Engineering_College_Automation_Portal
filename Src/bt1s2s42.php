...
$ssql = "SELECT s4 FROM bsi  WHERE sem= '2' ";
...
<div id="top14">
	  ...
	  <table align="center" class="myTable" width="80%" style="border-collapse: collapse">
          ...
          <tr>  <th width="25%" >B.Tech  I<sup>st</sup> Year &nbsp;&nbsp;</th>
		  <th width="25%" >II<sup>nd</sup> Semester &nbsp;&nbsp;[ MID 2 ] </th>
...
//echo "$s";
echo "<form  method='post' action='succes.php?stid=". $qrow['stid'] ."   &    rno=" . $qrow['rno'] ." & sub= ".$s4."  & pg= ".$page." & pid= ".$pid." & fmid=".$m." & edu=".$edu." '>";
...
echo " <td width='10%'>";
echo " <input class='minput' name='marks'  type='number' min=1 max=30 maxlength='2' placeholder=". $qrow["s4"]. "  required style='font-weight: bold; font-family: Century Gothic; color: #85144b' /></td>";

echo "<td  width='10%' >  <button class='button1'> Update </button> </td>";

echo "<td  width='10%' ><p align='center' style='font-size:20px; color:#85144b'>" . $qrow["s4"].  " </p> </td>";
