...
$csql = "SELECT s1 FROM fbatiiii WHERE fname='$as' ";
...
$dsql = "SELECT s1 FROM fbatiiii WHERE fname='$bs' ";
...
$esql = "SELECT s1 FROM fbatiiii WHERE fname='$cs' ";
...
$fsql = "SELECT s1 FROM fbatiiii WHERE fname='$ds' ";
...
$gsql = "SELECT s1 FROM fbatiiii WHERE fname='$es' ";
...
$hsql = "SELECT s1 FROM fbatiiii WHERE fname='$fs' ";
...
$isql = "SELECT l1 FROM fbatiiii WHERE fname='$gl' ";
...
$zsql = "SELECT l1 FROM fbatiiii WHERE fname='$hl' ";
