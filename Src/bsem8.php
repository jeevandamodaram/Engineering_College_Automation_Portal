...
$sql = "SELECT * FROM midi  WHERE stid='$stid' OR rno='$rno' AND pyear='4' AND edu='b'  ";
...
echo"$il1"; 
echo"$il2"; 
$asql = "SELECT * FROM midii  WHERE stid='$stid' OR rno='$rno' AND pyear='4' AND edu='b'  ";
...
echo"</tr>";
$usql = "UPDATE mid SET m='$tmt', s1='$ms1',s2='$ms2',s3='$ms3',s4='$ms4',s5='$ms5',s6='$ms6',L1='$ml1',L2='$ml2'  WHERE stid='$stid' OR rno='$rno' AND pyear='4' AND edu='b'  ";
...
$psql = "SELECT * FROM mid WHERE  stid='$stid' AND pyear='4'  ";
...
if($wcheck=1){
   ...
   $dmsql="UPDATE studet SET mstatus=2 WHERE stid='$stid' AND pyear='4' AND edu='b'  ";
...
$bsql = "SELECT * FROM bati  WHERE stid='$stid' OR rno='$rno' AND pyear='4' AND edu='b'  ";
...
$csql = "SELECT s2 FROM fbatiiii WHERE fname='$as' ";
...
$dsql = "SELECT s2 FROM fbatiiii WHERE fname='$bs' ";
...
$esql = "SELECT s2 FROM fbatiiii WHERE fname='$cs' ";
...
$fsql = "SELECT s2 FROM fbatiiii WHERE fname='$ds' ";
...
$gsql = "SELECT s2 FROM fbatiiii WHERE fname='$es' ";
...
$hsql = "SELECT s2 FROM fbatiiii WHERE fname='$fs' ";
...
$isql = "SELECT l2 FROM fbatiiii WHERE fname='$gl' ";
...
$zsql = "SELECT l2 FROM fbatiiii WHERE fname='$hl' ";
...
$lsql = "UPDATE mid SET atd='$tat'   WHERE stid='$stid' OR rno='$rno' AND pyear='4' AND edu='b'  ";
...
$ksql = "SELECT * FROM mid  WHERE stid='$stid' OR rno='$rno' AND pyear='4' AND edu='b'  ";
...
if($qcheck>=1){
   $qquery="UPDATE studet SET astatus=2 WHERE stid='$stid' AND pyear='4' AND edu='b'  ";
...
$pqsql = "UPDATE  stuclear SET d='1' WHERE sem='1'  ";
if ($conn->query($pqsql) === TRUE) {
} else {
    echo "Error: " . $pqsql . "<br>" . $conn->error;
}
//$amsql = "UPDATE studet SET mstatus=2 WHERE stid='$stid' OR rnumber='$rno' AND pyear='4' AND edu='b'  ";
...
//$bmsql = "UPDATE studet SET astatus=2 WHERE stid='$stid' OR rnumber='$rno' AND pyear='4' AND edu='b'  ";
