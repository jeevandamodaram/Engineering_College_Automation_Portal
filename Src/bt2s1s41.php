...
$ssql = "SELECT s4 FROM bsii  WHERE sem= '1' ";
...
<script type="text/javascript" src="js/s4Slider.js"></script>
  <script>
...
//echo "$s";
echo "<form  method='post' action='succes.php?stid=". $qrow['stid'] ."   &  rno=" . $qrow['rno'] ." & sub= ".$s4."  & pg= ".$page." & pid= ".$pid." & fmid=".$m." '>";
